    ...
    <div className='max-w-5xl mx-auto p-6 shadow-md rounded-md'>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
                ...
                className='w-full border bprder-gray-300 rounded-md p-2' 
                required/>
            </div>
            ...
            {/* Description */}
             <div className="mb-6">
                ...
                className='w-full border broder-gray-300 rounded-md p-2'
                rows={4}
                required/>
            </div>
            {/* Price */}
            <div className='mb-6'>
             ...
             hover:bg-green-600 transition-colours'>Update Product</button>
        </form>
    </div>
  )
}
