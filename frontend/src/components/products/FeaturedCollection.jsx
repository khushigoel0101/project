...
const FeaturedCollection = () => {
  return <section className='py-16 px-4 lg:px-0'>
    <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center bg-black ">
        ...
        className="bg-gray-400 text-white px-6 py-3 rounded-lg text-lg hover:bg-gray-800">
            Shop Now
        </Link>
        </div>
